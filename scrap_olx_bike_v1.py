...
class scrap_olx_ads():
    ...
    def buscarDadosOLX(self, estado= "SP", regiao = "11", palavra = "fixa"):
        ...
        if regiao == "0":
            self.url = f"https://{estado}.olx.com.br/ciclismo?q={palavra}&sf=1"

        else:
            self.url = f"https://{estado}.olx.com.br/{regiaoBuscar[regiao]}/ciclismo?q={palavra}&sf=1"
